...
const Header: React.FC = () => {
    return(
        <header className="sticky flex flex-wrap items-center justify-between mx-auto p-4 bg-white top-0 flew-grow shadow z-20">
          <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="\portfolioLogo.png" className="h-10" alt="Deanna Woodhouse-Hawkins Logo" />
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Deanna Woodhouse-Hawkins</span>
          </Link>
